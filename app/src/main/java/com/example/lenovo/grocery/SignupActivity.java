...
public class SignupActivity extends AppCompatActivity {
    public TextView log;
    public EditText editpass, editrepass, editemail, editphone;
    public Button sign;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editrepass=findViewById(R.id.editTextConfirm);
    ...
    private void registerUser() {
        ...
        final String repassword = editrepass.getText().toString().trim();
...
*/
        ...
        if (TextUtils.isEmpty(repassword)) {
            editrepass.setError("Please confirm password");
